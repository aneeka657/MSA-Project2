...
def create_dataset_original_style(
    processed_dir="/Scratch/repository/msa/MSATSUNGPING/harmonix-original-preprocessed-data",
    output_file="./harmonix_data/test_data.npz"
):
    """
...
if __name__ == "__main__":
    ...
    dataset = create_dataset_original_style(
        processed_dir="./harmonix-original-preprocessed-data",
        output_file="./harmonix_data/test_data.npz"
    )
    
    # Verify it works
    verify_original_style_dataset("./harmonix_data/test_data.npz")
