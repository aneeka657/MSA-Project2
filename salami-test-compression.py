...
def create_dataset_original_style(
    processed_dir="/Scratch/repository/msa/MSATSUNGPING/salami-original-preprocessed-data",
    output_file="./salami_data/test_data.npz"
):
    """
...
if __name__ == "__main__":
    ...
    dataset = create_dataset_original_style(
        processed_dir="./salami-original-preprocessed-data",
        output_file="./salami_data/test_data.npz"
    )
    
    # Verify it works
    verify_original_style_dataset("./salami_data/test_data.npz")
