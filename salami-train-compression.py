...
def create_dataset_original_style(
    processed_dir="/Scratch/repository/msa/MSATSUNGPING/salami-aug-preprocessed-data",
    output_file="./salami_data/train_data.npz"
):
    """
...
if __name__ == "__main__":
    ...
    dataset = create_dataset_original_style(
        processed_dir="./salami-aug-preprocessed-data",
        output_file="./salami_data/train_data.npz"
    )
